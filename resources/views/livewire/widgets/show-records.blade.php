            ...
            <div wire:loading.remove>
                <div class="flex flex-row justify-evenly">
                    <div class="relative z-0 w-1/5 mb-6 group">
                        <a href="{{route('dash.zone', ['zone' => $zone])}}"><input disabled value="{{$zone}}" type="text" name="host" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/></a>
